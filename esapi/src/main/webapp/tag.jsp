...
<h3>Test Link(s)</h3>
<ul>
	<li><a href="http://localhost:8080/esapi/protect.html?<csrf:token uri="protect.html"/>">protect.html</a></li>
	<li><a href="protect.html">Attack protect.html</a></li>
	<li><a href="/esapi/protect.html">protect.html</a></li>
	<li><a href="http://localhost:8080/esapi/test.html?<csrf:token uri="http://localhost:8080/esapi/test.html"/>">http://localhost/test.html</a></li>
