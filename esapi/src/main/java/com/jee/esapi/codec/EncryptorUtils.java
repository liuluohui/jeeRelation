...
public class EncryptorUtils {
     ...
     * @throws EncryptionException
     */
    public static String encrypt(SecretKey key, String text) throws EncryptException {
        PlainText plainText = new PlainText(text);
     ...
     * @throws EncryptionException
     */
    public static String decrypt(byte[] data) throws EncryptException {
        try {
     ...
     * @throws EncryptionException
     */
    public static String decrypt(String text) throws IOException, EncryptException {
     ...
     * @throws EncryptionException
     */
    public static String decrypt(SecretKey key, byte[] data) throws EncryptException {
        try {
     ...
     * @throws EncryptionException
     */
    public static String decrypt(SecretKey key, String text) throws EncryptException, IOException {
        byte[] data = encoder.decodeFromBase64(text);
     ...
     */
    public static String hash(String text, String salt) throws EncryptException {
     ...
     * @throws EncryptException
     */
    public static String hash(String text, String salt, int iterations) throws EncryptException {
        try {
     ...
     * @throws EncryptException
     */
    public static String sign(String text) throws EncryptException {
        try {
     ...
     * @return
     */
    public static boolean verifySignature(String sign, String data) {
     ...
     */
    public static String seal(String text, long expiration) throws EncryptException {
        try {
     ...
     * @throws EncryptException
     */
    public static String unseal(String text) throws EncryptException {
        try {
     ...
     * @return
     */
    public static boolean verifySeal(String text) {
        return encryptor.verifySeal(text);
    }
